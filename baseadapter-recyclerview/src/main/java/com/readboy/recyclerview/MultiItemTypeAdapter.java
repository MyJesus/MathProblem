...
import com.readboy.recyclerview.base.ItemViewDelegate;
import com.readboy.recyclerview.base.ItemViewDelegateManager;
            ...
            public void onClick(View v) {
                if (mOnItemClickListener != null) {
                    ...
                    if (position >= 0 && position < mDatas.size()) {
                        ...
                        Log.e(TAG, "onClick: viewHolder not exit, position = " + position);
                    }
                }
            }
        });
