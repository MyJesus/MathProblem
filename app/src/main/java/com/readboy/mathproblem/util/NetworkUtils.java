...
public class NetworkUtils {
     ...
     * 正在使用移动数据流量
     */
    public static boolean isUsingDataTraffic(int networkType) {
        return networkType == NETWORK_2G || networkType == NETWORK_3G || networkType == NETWORK_4G;
    }

    public static boolean isUsingDataTraffic(Context context) {
